// Here we have solved "Rat in Maze " problem  in which the a matric is given and we have to find all paths we can reach to last node 
// without revisiting the node that has been visited once . 
